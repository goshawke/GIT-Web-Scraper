...
def filter_results(project,license,language,date,stars):
    print("Filter functions")
    language = request.args.get("lang", default="C")
    ...
    result = ontology.intersection_of_filters(license,language,stars,date)

    results = []

    for each_result in result:
        temp_repo = ontology.getattr(ontology.onto,each_result)
        temp_result = {
