...
'''
def create_project(onto, title, owner, language, licenses, num_stars, last_modified_date):
...
c = create_project(onto,title="Sample Project 1", owner="Connor", language=Prop_C, licenses=["MIT_License"], num_stars=3000, last_modified_date=datetime(2023, 5, 10))
destroy_entity(c)
d = create_project(onto, title="Sample Project 2", owner="Darshil", language=Prop_C_Plus_Plus, licenses=["GNU_General_Public_License"], num_stars=2000, last_modified_date=datetime(2023, 5, 4))
destroy_entity(d)
e =  create_project(onto, title="Sample Project 3", owner="Luke", language=Prop_C_Sharp, licenses=[Prop_BSD_2_Clause_Simplified_License], num_stars=1251, last_modified_date=datetime(2023, 5, 1))
destroy_entity(e)
